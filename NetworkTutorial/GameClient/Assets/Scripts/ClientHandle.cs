...
public class ClientHandle : MonoBehaviour
{
    ...
    public static void ItemSpawned(Packet _packet)
    {
        ...
        if(GameManager.itemSpawners.TryGetValue(_spawnerId,out ItemSpawner item))
        {
            item.ItemSpawned();
        }
    }
    ...
    public static void ProjectilePosition(Packet _packet)
    {
        ...
        if (GameManager.projectiles.TryGetValue(_projectileId, out ProjectileManager projectile))
        {
    ...
    public static void EnemyPosition(Packet _packet)
    {
        ...
        if(GameManager.enemies.TryGetValue(_enemyId,out EnemyManager enemy))
        {
